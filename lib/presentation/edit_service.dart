...
class EditService extends StatefulWidget {
  Package package;
  EditService({required this.package, Key? key}) : super(key: key);
...
class _EditServiceState extends State<EditService> {
  ...
  void initState() {
    super.initState();
    descController.text = widget.package.desc!;
    nameController.text = widget.package.title!;
    companyController.text = widget.package.company!;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Edit " + widget.package.title!),
        centerTitle: true,
        elevation: 1,
      ),
      body: SafeArea(
  ...
  _updatePackage() async {
    if (nameController.text.isNotEmpty &&
      ...
      final data = <String, dynamic>{
        ...
        "serviceCategory": widget.package.serviceCategory,
        "imageUrl1": url1,
        "imageUrl2": "-",
        "imageUrl3": "-",
      };
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content: Text(
              "Berhasil memperbarui data layanan. Silakan refresh halaman.")));
    } else {
